	...
	settings: {
		...
		plugin_filter: {
			...
			groups: {
				...
				empty_groups: "No groups yet — click \"Add group\" to create one",
				empty_members: "No members yet — search below to add",
				search_placeholder: "Search plugins by name or ID…",
				member_count: "{count} plugins",
				missing: "Not installed",
				remove_member: "Remove",
				delete_group: "Delete group",
				group_name_aria: "Group name",
				summary: "{groups} groups · {members} members",
