	...
	settings: {
		...
		plugin_filter: {
			...
			groups: {
				...
				add_group: "新增分組",
				unnamed: "未命名分組",
				empty_groups: "還沒有分組，點擊「新增分組」建立",
				empty_members: "暫無成員，在下方搜尋新增",
				search_placeholder: "輸入外掛名或 ID 搜尋新增…",
				member_count: "{count} 個外掛",
				missing: "未安裝",
				remove_member: "移除",
				delete_group: "刪除分組",
				group_name_aria: "分組名稱",
				summary: "{groups} 個分組 · {members} 名成員",
				collapse: "收合分組",
				expand: "展開分組",
				confirm_delete: "再點一次確認刪除",
				status_enabled: "已啟用",
				status_disabled: "未啟用",
			},
			all: "全部 ({count})",
