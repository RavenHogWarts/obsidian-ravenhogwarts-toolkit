	...
	settings: {
		folder_templates: {
			...
			scopes: {
				...
				typeRoot: "根目录（含所有子文件夹）",
				rootHint: "整库生效，仅被排除条件收窄；作为兜底建议放在规则列表末尾",
		...
		plugin_filter: {
			...
			groups: {
				...
				add_group: "添加分组",
				unnamed: "未命名分组",
				empty_groups: "还没有分组，点击「添加分组」创建",
				empty_members: "暂无成员，在下方搜索添加",
				search_placeholder: "输入插件名或 ID 搜索添加…",
				member_count: "{count} 个插件",
				missing: "未安装",
				remove_member: "移除",
				delete_group: "删除分组",
				group_name_aria: "分组名称",
				summary: "{groups} 个分组 · {members} 名成员",
				collapse: "收起分组",
				expand: "展开分组",
				confirm_delete: "再点一次确认删除",
				status_enabled: "已启用",
				status_disabled: "未启用",
			},
			all: "全部 ({count})",
