		...
		<div className="tableEnhancements-formula-modal">
			<div className="tableEnhancements-formula-header">
				<div className="tableEnhancements-form-group">
					<label>
						{t("toolkit.tableEnhancements.formula.output_type")}
					</label>
					<select
						value={output}
						onChange={(e) =>
							setOutput(e.target.value as OutputType)
						}
				...
				<div className="tableEnhancements-form-group">
					<label>
						{t("toolkit.tableEnhancements.formula.output_value")}
					</label>
					<input
						type="text"
						value={outputValue}
			...
			<div className="tableEnhancements-formula-footer">
				<button className="tableEnhancements-btn" onClick={onClose}>
				...
				>
					{isEditing
						...
						: t("toolkit.tableEnhancements.formula.add")}
				</button>
			</div>
		</div>
	);
