...
export const FUNCTION_HINTS: IFunctionHint[] = [
		...
		parameters: [
			{
				name: "modifier",
				description: t(
					"toolkit.tableEnhancements.formula_editor.math.count_modifier"
				),
	...
	},
	{
		...
		description: t(
			"toolkit.tableEnhancements.formula_editor.math.VARIANCE"
		),
	...
	},
	{
		...
		description: t(
			"toolkit.tableEnhancements.formula_editor.time.TIME_EARLIEST"
		),
		...
		parameters: [
			{
				name: "format",
				description: t(
					"toolkit.tableEnhancements.formula_editor.time.time_format"
				),
	...
	},
	{
		...
		description: t(
			"toolkit.tableEnhancements.formula_editor.time.TIME_LATEST"
		),
	...
	},
	{
		...
		description: t(
			"toolkit.tableEnhancements.formula_editor.time.TIME_SPAN"
		),
		...
		parameters: [
			...
			},
			{
				name: "unit",
				description: t(
					"toolkit.tableEnhancements.formula_editor.time.time_unit"
				),
